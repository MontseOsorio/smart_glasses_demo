    ...
    <i class="fas fa-shopping-cart" ></i>
        ...
        <div class="container">
            ...
            <%
                ...
                String ruta = request.getServletContext().getRealPath("/WEB-INF/RESOURCES/Ofertas1.json");
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    ...
                    <div class="card-info">
                        ...
                        <p>Precio antes: $ <%=producto.getFloat("precioAntes")%></p>
                        <p> <%=producto.getString("oferta")%></p>
